...
plugins=(git adb branch zsh-autosuggestions zsh-syntax-highlighting zsh-completions alias-finder aliases archlinux copypath git-auto-fetch github zsh-interactive-cd zsh-navigation-tools)
